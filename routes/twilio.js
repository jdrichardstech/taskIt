...
router.get('/notify', function(req, res, next) {
  ...
  router.post('/notify', function(req, res, next) {
    ...
    .then(function(profile){
      var msg = req.body.taskResponder + ' replied to your task, here is the message:\n\n '+ req.body.text +"\n\nView the profile for "+ req.body.taskResponder+ "here: https://jdrichardstech-tasker.herokuapp.com/api/profile/"+req.body.taskResponderId
...
//    res.render('index', { title: 'Express' })
    ...
    console.log("ANYTHING?___"+ JSON.stringify(task))
